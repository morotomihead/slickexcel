...
jQuery.fn.table2CSV = function(options) {
    ...
    var tmpCells =  dataView.getFilterItems();    

    for (var key in tmpCells) {    
		var row = tmpCells[key];
		var tmpRow = [];
    ...
    function popup(data) {
       $("body").append('<form id="exportform" action="./scripts/SlickGrid-Export-CSV/export.php" method="post"><input type="hidden" id="exportdata" name="exportdata" /></form>');
    $("#exportdata").val(data);
